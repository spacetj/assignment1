...
public class UserService implements UserStore {
    ...
    private UserService() {
        users.addAll(
                Arrays.asList(
                        UserFactory.getUser("Alpha", 20, "profile_pic_smilie", "Working at KFC", null, null),
                        UserFactory.getUser("Bravo", 18, "bravo_pic", "Bravo be brave", null, null),
                        UserFactory.getUser("Charly", 17, "charlr_pic", "Charly is knarly", null, null),
                        UserFactory.getUser("Delta", 30, "delta_pic", "Delta Goodrum is life", null, null),
                        UserFactory.getUser("Echo", 60, "echo_pic", "Echo forever", null, null),
                        UserFactory.getUser("Foxtror", 50, "fostrot_pic", "What does the foxtrot say?", null, null),
                        UserFactory.getUser("Golf", 40, "golf_pic", "Volkwagon golf gti tubo charged diesel", null, null),
                        UserFactory.getUser("Halo", 80, "halo_pic", "I can see your halo, halo, halo", null, null),
                        UserFactory.getUser("India", 30, "india_pic", "Chak de india", null, null),
                        UserFactory.getUser("Juliet", 40, "juliet_pic", "Romeo and Juliet", null, null),
                        UserFactory.getUser("Kilo", 53, "kilo_pic", "Kilo is just a number", null, null)
                )
        );
